...
{
    /// <summary>
    /// 멀티터치를 이용하여 오브젝트 위치이동 및 크기변경 관리 클래스
    /// </summary>
    public class TouchMultiple : TouchParent
    {
        #region OnAwakeInit
        ...
        [SerializeField] protected bool bScale = true; // 크기 조절 여부 변수
...
#else
            float fDistance = CalculateDistanceAvg(centerPos, positions); // 터치 평균 거리값 추출
            float fDeltaDistance = fDistance - fPrevDistance;
#endif
        }
        /// <summary>
        /// 타겟 크기 변경 함수
